...
//   TableRow,
// } from "@/components/ui/table";
// import { AlertCircle } from "lucide-react"; // Import AlertCircle for visual indicator
...
//   filteredRoles: Role[];
//   selectedRole: Role | null;
//   onRoleSelect: (role: Role) => Promise<void>; // Changed to Promise<void> to match CreateSimulation
//   onRunSimulation: () => Promise<void>; // Changed to Promise<void> to match CreateSimulation
//   savedChanges: boolean;
//   pendingChangesSummary: PendingChangesSummary | null;
//   getRoleChangesSummary: (roleId: string) => { changesCount: number; hasChanges: boolean };
// }
...
//           <Button
//             onClick={onRunSimulation}
//             disabled={!pendingChangesSummary || pendingChangesSummary.totalChanges === 0} // Disable if no pending changes
...
//                 <TableHead>GD</TableHead>
//                 <TableHead>Assigned to Users</TableHead>
//                 <TableHead>Pending Changes</TableHead> {/* New column for pending changes */}
//               </TableRow>
//             </TableHeader>
//             <TableBody>
//               {filteredRoles.length === 0 ? (
